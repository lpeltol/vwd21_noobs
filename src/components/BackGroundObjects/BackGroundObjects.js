...
class Cloud {
    ...
    draw(ctx) {
        ...
        ctx.moveTo(0, 0);
        ctx.bezierCurveTo(this.width * 0.01, -this.height * 0.96, this.width * 0.13, -this.height * 0.96, this.width * 0.33, -this.height * 0.5);
        ctx.bezierCurveTo(this.width * 0.40, -this.height * 0.92, this.width * 0.56, -this.height * 0.95, this.width * 0.66, -this.height * 0.4);
        ctx.bezierCurveTo(this.width * 0.78, -this.height * 0.82, this.width * 0.92, -this.height * 0.52, this.width, 0);
